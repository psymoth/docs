...
2. Analyze repository architecture with `code-context-search` first, then language tooling and direct source reads.
...
| `references/code-context-search.md`  | Code context search workflow           |
